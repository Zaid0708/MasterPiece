...
<body>
    ...
    <!-- Add styles for hiding and showing cart -->
                                ...
                                <div class="tp-header-2-category-list">
                                    <ul>
                                        @foreach ($categories as $category)
                                            <li><a href="course-with-sidebar.html">{{ $category->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="tp-header-2-contact d-flex align-items-center justify-content-end">
                                    ...
                                    <span>
                                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                                            ...
                                            <path d="M7.08973 10.1017H7.1355" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.9257 10.1017H12.9714" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                    <!-- Cart count (dynamic) -->
                                    <i class="cart-count">{{ count(session('cart', [])) }}</i>
                                </button>
                            </div>
                            ...
                            @if (!auth()->check())
                                <div class="tp-header-inner-btn home-2 d-none d-xxl-block">
                                    <a class="tp-btn-inner" href="{{ route('login.form') }}">Login</a>
                                </div>
                            @else
                                <div class="tp-header-inner-btn home-2 d-none d-xxl-block">
                            ...
                            @if (auth()->check())
                                <div class="tp-header-inner-login tp-header-user-hover">
                                    <button>
                                        @if (auth()->check() && $instructor && $instructor->profile_picture)
                                            <img src="{{ Storage::url($instructor->profile_picture) }}"
                                                alt="{{ auth()->user()->name }}">
                                        @else
                                            <img src="{{ asset('https://thumbs.dreamstime.com/b/default-profile-picture-avatar-photo-placeholder-vector-illustration-default-profile-picture-avatar-photo-placeholder-vector-189495158.jpg') }}"
                                    ...
                                    <div class="tp-header-user-box">
                                        <div class="tp-header-user-content">
                                            ...
                                            <div class="tp-header-user-list">
                                                <ul>
                                                    <li><a href="{{route('instructor-dashboard')}}"><span><svg width="16"
                                                    ...
                                                    <li><a href="instructor-enroll-course.html"><span><svg
                                                    ...
                                                    <li><a href="instructor-quiz-attempts.html"><span><svg
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="tp-footer-widget tp-footer-2-col-1 mb-30">
                                <div class="tp-footer-widget-logo mb-20 tp-header-logo">
                                    <a href="#"><img src="{{ asset('assets/img/logo/logo-black.png') }}"
                                            alt=""></a>
                                </div>
                                ...
                                <div class="tp-footer-contact">
                                    <div class="tp-footer-btn">
                                        <a class="tp-btn-round" href="contact.html">Contact Us
                                            <span>
                                                <svg width="14" height="11" viewBox="0 0 14 11"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M8.71533 1L13 5.28471L8.71533 9.56941"
                                                        stroke="currentColor" stroke-width="2" stroke-miterlimit="10"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M1 5.28467H12.88" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="p-footer-widget tp-footer-2-col-4 mb-30">
                                ...
                                <div class="tp-footer-app">
                                    <a href="#"><img src="{{ asset('assets/img/footer/google-play.jpg') }}"
                                            alt=""></a>
                                    <a href="#"><img src="{{ asset('assets/img/footer/apple-store.jpg') }}"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.add-to-cart').forEach(function(button) {
                button.addEventListener('click', function(e) {
                    ...
                    .then(data => {
                        ...
                        document.querySelector('.cartmini__area').innerHTML = data.cart_content;
            ...
            // Use event delegation for removing items from the cart
            document.addEventListener('click', function(e) {
                if (e.target.closest('.remove-from-cart')) {
                    e.preventDefault();
    
                    const courseId = e.target.closest('.remove-from-cart').getAttribute('data-id');
