                                                ...
                                                <div class="accordion-body">
                                                    <div class="tpd-new-course-box-1">
                                                        ...
                                                        <div class="tpd-input">
                                                            ...
                                                            <input type="text" name="lesson_content" placeholder="Lesson Content" required>
                                                        </div>
                
                                                        <div class="tpd-input about-height">
                                                            <label>Lesson Order</label>
                                                            <input type="number" name="lesson_order" placeholder="Lesson Order" required>
                                                        </div>
                
                                                        <div class="tpd-new-course-select2">
                                                            <div class="tpd-input">
                                                                <label>Course Name</label>
                                                                <input disabled type="text" value="{{ $course->title }}">
                                                                <input type="hidden" name="course_id" value="{{ $course->id }}"> <!-- Hidden course_id -->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="tpd-new-course-select2">
                                                            <div class="tpd-input">
                                                                ...
                                                                <select class="tpd-select2 form-select" name="topic_id" required multiple>
                                                        ...
                                                        <input type="file" id="lesson_video" name="lesson_video" accept="video/*" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
