...
<main class="tp-dashboard-body-bg">
   ...
   <section class="tp-dashboard-banner-wrap">
      <div class="tp-dashboard-banner-shape"><img src="" alt=""></div>
      <div class="container">
         <div class="row">
            <div class="col-lg-12">
               <div class="tp-dashboard-banner-bg mt-30" data-background="https://png.pngtree.com/background/20210717/original/pngtree-professional-blue-hexagon-tehcnology-background-for-business-picture-image_1416228.jpg">
                  <div class="tp-instructor-wrap d-flex justify-content-between">
                     <div class="tp-instructor-info d-flex">
                        <div class="tp-instructor-avatar">
                           <img src="{{ Storage::url($instructor->profile_picture) }}" alt="Instructor Profile Picture">

                        </div>
                        <div class="tp-instructor-content">
                           <h4 class="tp-instructor-title">{{$user->name}}</h4>
                     ...
                     <div class="tp-instructor-course-btn">
                        <a class="tp-btn-add-course" href="/create-course"><i class="fa-regular fa-plus"></i> Create a New Course</a>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="tp-user-menu">
                        <nav>
                           <ul>
                              ...
                              <li>
                                  <a class="{{ Route::is('instructor-dashboard') ? 'active' : '' }}" href="{{ route('instructor-dashboard') }}">
                                      <span>
                              ...
                              <li>
                                  <a class="{{ Route::is('instructor-profile') ? 'active' : '' }}" href="{{ route('instructor-profile') }}">
                                      <span>
                              ...
                              <li>
                                 <a class="{{ Route::is('instructor-courses') ? 'active' : '' }}" href="{{ route('instructor-courses') }}">
                                    <span>
                                       <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <li>
                                 <a class="{{ Route::is('instructor.topics') ? 'active' : '' }}" href="{{ route('instructor.topics') }}">
                                    <span>
                                       <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
